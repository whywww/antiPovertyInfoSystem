    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" class="navbar navbar-default navbar-static-top">
            <div class="navbar-header">
                ...
                <a id="logo" href="/user/managePage.do" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text"><strong>精准扶贫</strong></span><span style="display: none" class="logo-text-icon">µ</span></a></div>
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">
                        <strong>首页</strong></div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a href="/user/managePage.do">首页</a></li>
                </ol>
                <div class="clearfix">
                </div>
            </div>
            ...
            <div class="page-content">
                <div id="tab-general">
                    <div class="row mbl">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="text-center mbl"><h2><p><strong>欢迎进入精准扶贫信息管理系统！</strong></p></h2>
                                </div>
                                <div class="text-center mbl"><h2><p><strong>Welcome to targeted poverty alleviation information system!</strong></p></h2>
                                </div>
                                <div class="text-center mbl">
                                    <div class="alert alert-info"><strong>该信息管理系统仅能够通过管理员账户登录。</strong>
                                    </div>
                                </div>
                                <div class="text-center mbl">
                                    <div class="alert alert-success"><strong>祝您使用愉快！</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
